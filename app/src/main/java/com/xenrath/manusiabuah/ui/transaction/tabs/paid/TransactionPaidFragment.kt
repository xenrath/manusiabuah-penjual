...
class TransactionPaidFragment : Fragment(), TransactionPaidContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionPaidPresenter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionPaidPresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.transactionPaid(prefManager.prefId)
    }
