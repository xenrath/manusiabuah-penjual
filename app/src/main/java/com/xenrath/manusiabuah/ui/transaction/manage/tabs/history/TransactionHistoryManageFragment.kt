...
class TransactionHistoryManageFragment : Fragment(), TransactionHistoryManageContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionHistoryManagePresenter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionHistoryManagePresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.transactionHistoryManage(prefManager.prefId)
    }
