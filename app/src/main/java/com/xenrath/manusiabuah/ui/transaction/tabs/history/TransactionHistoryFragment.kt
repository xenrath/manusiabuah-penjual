...
class TransactionHistoryFragment : Fragment(), TransactionHistoryContract.View {
    ...
    override fun onCreateView(
        ...
        presenter = TransactionHistoryPresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.transactionHistory(prefManager.prefId)
    }
