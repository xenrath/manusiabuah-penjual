...
class MyBargainAcceptedFragment : Fragment(), MyBargainAcceptedContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: MyBargainAcceptedPresenter
    ...
    override fun onCreateView(
        ...
        presenter = MyBargainAcceptedPresenter(this)
