...
class ProductMapsActivity : AppCompatActivity(), ProductMapsContract.View, OnMapReadyCallback {

    lateinit var presenter: ProductMapsPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = ProductMapsPresenter(this)
    }

    override fun initActivity() {
        tv_title.text = "Lokasi"
