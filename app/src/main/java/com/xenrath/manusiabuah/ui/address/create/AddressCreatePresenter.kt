...
class AddressCreatePresenter(val view: AddressCreateContract.View): AddressCreateContract.Presenter {
    ...
    override fun addressCreate(
        ...
        view.onLoading(true, "Menambahkan alamat...")
