...
class TransactionPackedManagePresenter(val view: TransactionPackedManageContract.View) :
    TransactionPackedManageContract.Presenter {
    override fun transactionPackedManage(id: Long) {
        view.onLoading(true, "Menampilkan pesanan...")
        ApiService.endPoint.transactionPackedManage(id)
