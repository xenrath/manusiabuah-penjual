...
class TransactionDoneFragment : Fragment(), TransactionDoneContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionDonePresenter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionDonePresenter(this)
