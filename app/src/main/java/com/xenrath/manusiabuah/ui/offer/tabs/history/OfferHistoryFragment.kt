...
class OfferHistoryFragment : Fragment(), OfferHistoryContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: OfferHistoryPresenter
    ...
    override fun onCreateView(
        ...
        presenter = OfferHistoryPresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.offerHistory(prefManager.prefId)
    }
