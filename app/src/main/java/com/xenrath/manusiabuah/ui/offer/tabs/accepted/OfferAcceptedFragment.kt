...
class OfferAcceptedFragment : Fragment(), OfferAcceptedContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: OfferAcceptedPresenter
    ...
    override fun onCreateView(
        ...
        presenter = OfferAcceptedPresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.offerAccepted(prefManager.prefId)
    }
