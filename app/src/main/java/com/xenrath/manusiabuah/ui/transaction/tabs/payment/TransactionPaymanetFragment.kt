...
class TransactionPaymanetFragment : Fragment(), TransactionPaymentContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionPaymentPresenter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionPaymentPresenter(this)
