...
class MyBargainWaitingFragment : Fragment(), MyBargainWaitingContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: MyBargainWaitingPresenter
    ...
    override fun onCreateView(
        ...
        presenter = MyBargainWaitingPresenter(this)
