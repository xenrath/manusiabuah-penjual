...
import com.xenrath.manusiabuah.ui.transaction.manage.TransactionManageAdapter
import com.xenrath.manusiabuah.utils.sweetalert.SweetAlertDialog

class TransactionPackedManageFragment : Fragment(), TransactionPackedManageContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionPackedManagePresenter

    private lateinit var adapterTransaction: TransactionManageAdapter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionPackedManagePresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.transactionPackedManage(prefManager.prefId)
    }
    ...
    override fun initFragment(view: View) {
        ...
        adapterTransaction = TransactionManageAdapter(requireActivity(), ArrayList())
