...
class TransactionSentManageFragment : Fragment(), TransactionSentManageContract.View {

    lateinit var prefManager: PrefManager
    lateinit var presenter: TransactionSentManagePresenter
    ...
    override fun onCreateView(
        ...
        presenter = TransactionSentManagePresenter(this)
    ...
    override fun onStart() {
        super.onStart()
        presenter.transactionSentManage(prefManager.prefId)
    }
